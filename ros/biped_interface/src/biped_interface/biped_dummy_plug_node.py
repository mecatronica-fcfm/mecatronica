...
from Tkinter import *
from biped_interface.msg import *
...
left_hip_bar = Scale(win, from_=0, to=255, orient=HORIZONTAL, command=callback_left_hip)
left_hip_bar.grid(in_=frame_left, row=0, column=100, sticky=E)
left_hip_bar.set(128)

left_knee_bar = Scale(win, from_=0, to=255, orient=HORIZONTAL, command=callback_left_knee)
left_knee_bar.grid(in_=frame_left, row=1, column=100, sticky=E)
left_knee_bar.set(128)

left_ankle_bar = Scale(win, from_=0, to=255, orient=HORIZONTAL, command=callback_left_ankle)
left_ankle_bar.grid(in_=frame_left, row=2, column=100, sticky=E)
left_ankle_bar.set(128)

right_hip_bar = Scale(win, from_=0, to=255, orient=HORIZONTAL, command=callback_right_hip)
right_hip_bar.grid(in_=frame_right, row=0, column=100, sticky=E)
right_hip_bar.set(128)

right_knee_bar = Scale(win, from_=0, to=255, orient=HORIZONTAL, command=callback_right_knee)
right_knee_bar.grid(in_=frame_right, row=1, column=100, sticky=E)
right_knee_bar.set(128)

right_ankle_bar = Scale(win, from_=0, to=255, orient=HORIZONTAL, command=callback_right_ankle)
right_ankle_bar.grid(in_=frame_right, row=2, column=100, sticky=E)
right_ankle_bar.set(128)
